...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#FFF8F7] via-white to-[#F9FBFF]">
      ...
      {/* Our Services */}
      <section className="py-16 px-6 max-w-[1120px] mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-[#B71C1C] text-center mb-10">Our Services Include</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={item.title}
              className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md border border-[#FFE5E5] hover:border-[#FFCDD2] hover:scale-[1.02] transition-transform"
            >
      ...
      {/* Why Choose Us */}
      <section className="bg-gradient-to-br from-[#FFF8F7] to-[#F9FBFF] pb-14 px-6">
        <div className="max-w-[1120px] mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#B71C1C] mb-10">Why Choose Us</h2>
          <div className="grid md:grid-cols-3 gap-8 text-left">
            {[
              ...
              {
                icon: <Lightbulb className="w-8 h-8 text-[#E53935]" />,
      ...
      <section className="py-16 px-6 bg-white border-t border-gray-100">
        <div className="max-w-[1120px] mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#B71C1C] mb-6">Our Students Have Been Admitted To</h2>
      ...
      {/* Closing Section */}
      <section className="relative bg-gradient-to-br from-[#FFF3F3] via-white to-[#F9FBFF] py-16 text-center px-6">
        <div className="max-w-4xl mx-auto">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-64 bg-[radial-gradient(ellipse_at_center,_rgba(229,57,53,0.12)_0%,_transparent_70%)]" />
        </div>
      </section>
