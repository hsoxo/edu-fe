      ...
      <main className="bg-white text-gray-800">
        ...
        <section className="max-w-[1120px] mx-auto px-6 py-20">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-[#B71C1C] mb-3">Our Culture</h2>
          ...
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-[#B71C1C] mb-3">Our Promise</h2>
            <p className="text-gray-600 max-w-4xl mx-auto leading-relaxed">
        ...
        <section className="bg-slate-50 py-20">
          <div className="max-w-[1120px] mx-auto px-6">
            <div className="flex items-center justify-center mb-10 gap-2">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#B71C1C]">Career Opportunities</h2>
            </div>
            ...
            <div className="space-y-6">
              {jobs.map((job, i) => (
                <div
                  key={i}
                  className="bg-white p-8 rounded-2xl border border-gray-200 hover:border-[#E53935]/30 transition-all duration-300"
                >
                  ...
                  <a
                    ...
                    className="inline-block font-medium text-[#B71C1C] transition-colors hover:text-[#E53935]"
                  >
                    Contact us →
                  </a>
                </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-10">
              ...
              <a href="mailto:vanlearnedu@gmail.com" className="underline hover:text-[#B71C1C]">
