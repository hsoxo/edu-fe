    ...
    <section className="py-20 bg-gradient-to-b from-white to-rose-50">
      <div className="max-w-[1120px] mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          {/* Left text */}
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold text-rose-600 mb-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8">
          {pillars.map((pillar, i) => (
            <div
              key={i}
              className="relative rounded-xl border border-gray-200 bg-rose-50 p-8 pb-12 hover:shadow-lg transition"
            >
              {/* 顶部渐变条 */}
              <div className="absolute top-0 left-0 right-0 h-1 rounded-t-xl bg-gradient-to-r from-rose-500 to-pink-400"></div>

              {/* Icon + Title */}
              <div className="flex items-center mb-4 space-x-3 mt-2">
                <div className="w-12 h-12 flex items-center justify-center rounded-md bg-rose-100">
                  {pillar.icon}
                </div>
